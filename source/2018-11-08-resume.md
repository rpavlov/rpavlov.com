...
roumen@rpavlov.com
## Technical skills
**Languages** Ruby, Python, SQL, Javascript, Java, C, Clojure, HTML, CSS

***Frameworks*** Ruby on Rails, Flask, AngularJs, jQuery, Bootstrap

***Tools*** Linux, AWS, Ansible, Docker, Vagrant, Git, Postgresql, Mysql, nginx, RabbitMQ/Celery/Resque, Elasticsearch

***Project management*** Full lifecycle project development; requirements gathering, estimation, sprint planning, release and maintenance.
