...
* Implemented and maintained features of a Rails API and frontend. Subsequently containerized the API with Docker and setup a hosting & deployment workflow in Amazon ECS.
